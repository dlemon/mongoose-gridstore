![alt tag](https://travis-ci.org/dlemon/mongoose-gridstore.svg?branch=master) ![NPM version][npm-version-image] [![NPM downloads][npm-downloads-image]][npm-url] [![MIT License][license-image]][license-url]
